...
(function(){
  ...
  function initLyricPlayer(cfg){
    ...
    if(!controls){ controls = document.createElement('div'); 
      controls.className='controls main-controls'; 
      container.insertBefore(controls, lyricsBody); 
    }
  ...
  // Force visibility (page CSS initializes tooltip-box hidden)
  div.style.opacity='1';
